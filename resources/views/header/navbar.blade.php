...
<body>
  <nav class="navbar navbar-expand-sm bg-primary shadow fixed-top">
    <div class="container-fluid">
      <a class="navbar-brand text-white" style="margin-left:20px" href="{{ url('/index-mhs')}}">Universitas 17 Agustus 1945</a>
          ...
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <li><a class="dropdown-item" href="{{ url('/sirkulasi')}}">Sirkulasi</a></li>
              </ul>
            </li>
            <li class="nav-item">
